...
public class SendBallControleDirect : MonoBehaviour
{
    public BallMovementDirect ballPrefab; // Le prefab de votre balle
    ...
    {
        hasShoot = true;
        BallMovementDirect newBall = Instantiate(ballPrefab, shootPoint.position, shootPoint.rotation);
        newBall.listBalises = listBalises;
        newBall.playerMovement = playerMovement;
        newBall.sendBallControleDirect = this;
